...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li <?php if(Route::current()->uri() == 'charts') echo 'class="active"'; ?>> <a href="{{ route('alumno.index') }}"><i class="icon-group"></i> <span>Alumnos</span></a> </li>
    ...
    <li <?php if(Route::current()->uri() == 'widgets') echo 'class="active"'; ?>> <a href="{{ route('addons.calendar') }}"><i class="icon-calendar"></i> <span>Calendario</span></a> </li>
